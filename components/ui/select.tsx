...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        // Borne la hauteur à l'espace disponible calculé par Radix afin que la
        // liste ne déborde jamais de la viewport (formulaires avec beaucoup de
        // questions, Q1…Q60+), et active le scroll interne.
    ...
    >
      ...
      <SelectPrimitive.Viewport
        className={cn(
          "p-1",
          // En mode popper on ne force PAS la hauteur sur la viewport (l'ancien
          // h-[trigger-height] la limitait à la hauteur d'une seule ligne et
          // cassait le défilement) — seule la largeur est alignée au trigger.
          position === "popper" &&
