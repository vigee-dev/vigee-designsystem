...
>(({ className, sideOffset = 4, collisionPadding = 8, ...props }, ref) => (
  // Portail : rendue dans le body, l'infobulle n'est plus coupée par un
  // ancêtre à overflow caché (tiroir, panneau, en-tête collant). Le padding
  // de collision la garde dans la fenêtre : au bord, elle change de côté.
