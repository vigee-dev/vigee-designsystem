...
const DatePickerRange = ({
  ...
  const urlDateRange = React.useMemo<DateRange | undefined>(() => {
  ...
  const dateRange = isControlled ? controlledDate : urlDateRange;
  ...
  const handleDateChange = React.useCallback(
    (newDate: DateRange | undefined, newPeriod?: string) => {
      ...
      if (isControlled && controlledSetDate) {
    ...
    [onChange, setStartDate, setEndDate, isControlled, controlledSetDate]
  );
