...
export default function Search({
  ...
  return (
    <div
      className={cn(
        "relative flex flex-1 items-center max-w-lg flex-shrink-0 md:max-w-sm min-w-[200px] text-primary gap-2",
        className
      )}
    >
      {(label || description) && (
      ...
      <div className="relative flex flex-1">
        <input
          className="peer block w-full font-variations rounded-md border border-slate-200 py-[9px] pl-10 pr-2 text-[16px] md:text-sm outline-2 placeholder:text-slate-400"
