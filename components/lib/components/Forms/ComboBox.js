...
export function ComboBox(_a) {
    ...
    return (_jsxs(Popover, { open: open, onOpenChange: setOpen, children: [label && (_jsx(FormLabel, { className: "font-black text-primary pb-2", children: label })), _jsx(PopoverTrigger, { asChild: true, children: _jsxs(Button, { variant: "outline", role: "combobox", "aria-expanded": open, className: "w-full flex gap-x-2 bg-input border-0 justify-between", children: [_jsxs("div", { className: "flex gap-x-2 items-center", children: [icon && icon, value
                                    ? (_b = items.find(function (item) { return item.value === value; })) === null || _b === void 0 ? void 0 : _b.label
                                    : placeholder] }), _jsx(ChevronsUpDown, { className: "ml-2 h-4 w-4 shrink-0 opacity-50" })] }) }), _jsx(PopoverContent, { className: "w-full p-0", children: _jsxs(Command, { filter: filterItems, children: [_jsx(CommandInput, { placeholder: "Rechercher..." }), _jsx(CommandEmpty, { children: "Aucun \u00E9l\u00E9ment trouv\u00E9." }), _jsx(CommandGroup, { className: "max-h-[200px]", children: _jsx(ScrollArea, { className: "h-[200px]", children: items.map(function (item) { return (_jsxs(CommandItem, { className: "max-h-[200px]", value: item.value, onSelect: function (currentValue) {
