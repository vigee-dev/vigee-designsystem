...
export default function SelectSearch<T extends FieldValues, Option, IsMulti extends boolean = false>({ name, label, form, placeholder, disabled, isClearable, preprocessOnChange, options, isMulti, defaultOptions, defaultValue, classNameContainer, }: SearchSelectInterface<T, Option, IsMulti>): import("react/jsx-runtime").JSX.Element;
export {};
