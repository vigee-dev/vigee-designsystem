...
export function DrawerMobile(_a) {
    ...
    if (isDesktop) {
        return (_jsx(DrawerContext.Provider, { value: contextValue, children: _jsxs(Dialog, { open: open, onOpenChange: setOpen, children: [_jsx(DialogTrigger, { onClick: function (e) { return e.stopPropagation(); }, asChild: true, children: trigger }), _jsx(ScrollArea, { className: "max-h-[80vh] ", children: _jsxs(DialogContent, { onClick: function (e) { return e.stopPropagation(); }, className: "max-w-[425px] ".concat(size === "sm"
                                ? "md:max-w-[425px]"
                                : size === "md"
                                    ? "md:max-w-[650px]"
                                    : "md:max-w-[1080px]", " "), children: [_jsx(DialogHeader, { children: _jsxs("div", { className: "flex items-center gap-x-4 p-4 py-2", children: [icon, _jsxs("div", { className: "flex flex-col", children: [_jsx(DialogTitle, { className: "text-primary", children: title }), _jsx(DialogDescription, { children: description })] })] }) }), _jsx("div", { className: "p-4", children: children })] }) })] }) }));
    }
    return (_jsx(DrawerContext.Provider, { value: contextValue, children: _jsxs(Drawer, { open: open, onOpenChange: setOpen, children: [_jsx(DrawerTrigger, { onClick: function (e) { return e.stopPropagation(); }, asChild: true, children: trigger }), _jsx(DrawerContent, { onClick: function (e) { return e.stopPropagation(); }, children: _jsxs("div", { className: "text-[16px] ", children: [_jsxs(ScrollArea, { className: "max-h-[80vh] pb-8 z-50", children: [_jsxs(DrawerHeader, { className: "text-left", children: [title && (_jsx(DrawerTitle, { className: "font-bold text-primary", children: title })), description && (_jsx(DrawerDescription, { children: description }))] }), _jsx("div", { className: "p-4", children: children })] }), cancelButton && (_jsx(DrawerFooter, { children: _jsx(DrawerClose, { asChild: true, children: _jsx(Button, { type: "button", variant: "outline", children: "Annuler" }) }) }))] }) })] }) }));
}
