...
var FormLabel = React.forwardRef(function (_a, ref) {
    ...
    return (_jsx(Label, __assign({ ref: ref, className: cn(error && "text-destructive", className), htmlFor: formItemId }, props)));
});
...
var FormDescription = React.forwardRef(function (_a, ref) {
    ...
    return (_jsx("p", __assign({ ref: ref, id: formDescriptionId, className: cn("text-sm text-muted-foreground", className) }, props)));
});
...
var FormMessage = React.forwardRef(function (_a, ref) {
    ...
    return (_jsx("p", __assign({ ref: ref, id: formMessageId, className: cn("text-sm font-medium text-destructive", className) }, props, { children: body })));
});
