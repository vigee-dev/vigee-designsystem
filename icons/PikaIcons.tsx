export function BarChartUp(props: JSX.IntrinsicElements["svg"]) {
  return (
    <svg
      {...props}
      style={{ color: "000" }}
...
export function ArrowUpCircle(props: JSX.IntrinsicElements["svg"]) {
  return (
    <svg
      ...
      strokeWidth="2"
    >
      <path d="M8 11.949a20.339 20.339 0 0 1 3.604-3.807A.627.627 0 0 1 12 8m4 3.949a20.337 20.337 0 0 0-3.604-3.807A.627.627 0 0 0 12 8m0 0v8m9.15-4a9.15 9.15 0 1 1-18.3 0 9.15 9.15 0 0 1 18.3 0Z" />
    </svg>
  );
}
...
export function UserUser(props: JSX.IntrinsicElements["svg"]) {
  return (
    ...
    >
      ...
      <path d="M16 15H8a4 4 0 0 0-4 4 2 2 0 0 0 2 2h12a2 2 0 0 0 2-2 4 4 0 0 0-4-4Z" />
    </svg>
  );
}
...
export function PhonePhone(props: JSX.IntrinsicElements["svg"]) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
      ...
      strokeWidth="2"
    >
      <path d="M5.407 12.974c-1.237-2.097-2.05-4.541-2.372-7.265-.141-1.196.6-2.455 1.862-2.662.397-.064.887-.055 1.29-.018 1.684.152 2.38 1.637 2.749 3.079a5.431 5.431 0 0 1-1.57 5.332c-.604.56-1.305 1.032-1.959 1.534Zm0 0a15.792 15.792 0 0 0 5.308 5.43m0 0c2.164 1.344 4.714 2.224 7.572 2.561 1.197.141 2.455-.6 2.662-1.863.07-.433.062-.93.01-1.366-.209-1.77-1.913-2.44-3.434-2.788a5.429 5.429 0 0 0-4.867 1.276c-.714.65-1.311 1.453-1.943 2.18Z" />
    </svg>
  );
}

export function CalendarCheck(props: JSX.IntrinsicElements["svg"]) {
  return (
    <svg
      {...props}
      style={{ color: "888" }}
