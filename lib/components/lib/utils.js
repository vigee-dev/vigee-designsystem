...
export var formatDateToLocal = function (dateStr, locale) {
...
export var generatePagination = function (currentPage, totalPages) {
...
export var truncateText = function (text, length) {
...
export var matchStatus = function (status) {
...
export var matchRolesStatus = function (status) {
    var color = "bg-gray-200 text-gray-600";
    var text = "admin";
    switch (status) {
        case "admin":
...
export var currency = function (number) {
    return {
        toEuro: function () {
