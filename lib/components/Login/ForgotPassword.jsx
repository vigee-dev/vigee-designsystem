...
function ForgotPassword(_a) {
    ...
    var mutation = (0, usePassword_1.useSendResetEmail)();
    var onSubmit = function (data) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    sonner_1.toast.success("un email de réinitialisation de mot de passe a été envoyé");
                    router.push("/login");
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _a.sent();
                    sonner_1.toast.error("Aucun compte n'est associé à cette adresse email.");
                    return [3 /*break*/, 3];
    ...
    return (<>
        <div className="w-full max-w-xl space-y-6 align-center my-auto justify-start mx-auto py-40 md:px-8 md:p-24 md:py-4 min-h-screen md:min-h-fit md:max-w-[480px]">
          <image_1.default width={100} height={100} className=" ml-4 md:ml-4 absolute md:relative top-12 md:top-0" src={logo} alt="Vigee - Make IT Simple"/>
          <div className="flex flex-col justify-start mx-auto md:shadow-sm  md:border border-gray-100 rounded-xl px-4 md:p-8  md:bg-white">
            <div>
              <Typography_1.TypographyH1 className="text-primary pb-4">
            ...
            return (<form_1.FormItem>
                          ...
                          <form_1.FormControl>
                            <input_1.Input placeholder="ex : test@email.com" {...field} className="text-[16px] md:text-sm"/>
                          </form_1.FormControl>
                ...
                <link_1.default href="/login" className="font-base hover:font-bold text-sm hover:text-primary flex gap-x-2 text-gray-400 transform hover:scale-105 transition duration-300 ease-in-out">
                  <solid_1.ArrowLongLeftIcon width={20}/>
                  Retour à la connexion
                </link_1.default>
                <div className="flex flex-col items-center ">
                  <div className="absolute md:relative bottom-12 md:bottom-0 w-full px-4 md:px-0 items-center gap-2 ">
                    <Button_1.Button pending={form.formState.isSubmitting} disabled={!email} type="submit" className="w-full h-12 text-md font-bold ">
                      Réinitialiser mon mot de passe
                    </Button_1.Button>
                  </div>
                </div>
