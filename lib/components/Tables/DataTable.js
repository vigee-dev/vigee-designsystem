...
export function DataTable(_a) {
  ...
  var title = _a.title,
    ...
    search = _a.search,
    lines = _a.lines,
    onNewClientClick = _a.onNewClientClick;
  var _c = React.useState([]),
    columnFilters = _c[0],
    setColumnFilters = _c[1];
  var _d = React.useState(undefined),
    globalFilter = _d[0],
    setGlobalFilter = _d[1];
  var _e = React.useState({}),
    rowSelection = _e[0],
    setRowSelection = _e[1];
  ...
  return _jsxs("div", {
    ...
    children: [
      _jsxs("div", {
        className:
          "flex justify-between items-center font-medium text-sm text-gray-400 pb-4 ",
        children: [
          title && _jsx("p", { children: title }),
          info && _jsx("p", { children: info }),
        ],
      }),
      _jsxs("div", {
        children: [
          _jsxs(Table, {
            children: [
              ...
              _jsx(TableBody, {
                children: (
                  (_b = table.getRowModel().rows) === null || _b === void 0
                    ? void 0
                    : _b.length
                )
                  ? table.getRowModel().rows.map(function (row) {
                      return _jsx(
                        TableRow,
                        {
                          ...
                          onClick: function () {
                            return onNewClientClick && onNewClientClick(row.id);
                          },
          ...
          table.getFilteredSelectedRowModel().rows.length > 0 &&
            _jsxs("div", {
              className: "flex-1 text-sm text-muted-foreground mt-2",
              children: [
                table
