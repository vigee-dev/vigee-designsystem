...
var SelectLabel = React.forwardRef(function (_a, ref) {
    ...
    return (_jsx(SelectPrimitive.Label, __assign({ ref: ref, className: cn("py-1.5 pl-8 pr-2 text-sm font-semibold", className) }, props)));
});
