...
var Table = React.forwardRef(function (_a, ref) {
  ...
  return _jsx("div", {
    className: "w-full overflow-auto border   sm:rounded-lg",
    children: _jsx(
      "table",
      __assign(
        {
...
var TableHeader = React.forwardRef(function (_a, ref) {
  ...
  return _jsx(
    "thead",
    __assign({ ref: ref, className: cn("[&_tr]:border-0 ", className) }, props)
  );
});
    ...
    __assign(
      {
        ref: ref,
        className: cn(
          "p-2 px-4 align-middle [&:has([role=checkbox])]:pr-0 text-sm text-gray-600",
          className
        ),
      },
      props
