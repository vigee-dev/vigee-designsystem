...
var ScrollArea = react_1.default.forwardRef(function (_a, ref) {
    var className = _a.className, children = _a.children, props = __rest(_a, ["className", "children"]);
    return (<ScrollAreaPrimitive.Root ref={ref} className={"relative overflow-hidden"} {...props}>
    <ScrollAreaPrimitive.Viewport className={(0, utils_1.cn)("max-h-min h-full w-full rounded-[inherit]", className)}>
      {children}
...
var ScrollBar = react_1.default.forwardRef(function (_a, ref) {
