...
var DrawerContent = React.forwardRef(function (_a, ref) {
    ...
    return (<DrawerPortal>
    <DrawerOverlay />
    <vaul_1.Drawer.Content ref={ref} className={(0, utils_1.cn)("fixed inset-x-0 bottom-0 z-50 mt-24 flex max-h-[90vh] flex-col rounded-t-[10px] border bg-background", className)} {...props}>
