...
export function AlertDialog(_a) {
  var btnQuestion = _a.btnQuestion,
    btnSubAlert = _a.btnSubAlert,
    _b = _a.colorBtn,
    colorBtn = _b === void 0 ? "outline" : _b,
    onClick = _a.onClick,
  ...
  return _jsxs(Alert, {
    open: isOpen,
    children: [
      _jsx(AlertDialogTrigger, { asChild: true, children: trigger }),
      _jsxs(AlertDialogContent, {
        className: "z-[1000]",
        children: [
          _jsxs(AlertDialogHeader, {
            children: [
              _jsx(AlertDialogTitle, { children: btnQuestion }),
              btnSubAlert &&
                _jsx(AlertDialogDescription, { children: btnSubAlert }),
            ],
          }),
