...
exports.DrawerMobileWithoutContext = exports.useDrawerContext = void 0;
...
function DrawerMobileWithoutContext(_a) {
        ...
        return (<DrawerContext.Provider value={contextValue}>
                ...
                : size === "md"
                    ...
                    : "md:max-w-[1080px]", " ")}>
                        ...
                        {size !== "sm" ? (<scroll_area_1.ScrollArea className="max-h-[80vh] pb-8 p-4">{children}</scroll_area_1.ScrollArea>) : (<div className="p-4">{children}</div>)}
            ...
            <drawer_1.Drawer open={open} onOpenChange={setOpen}>
                ...
                <drawer_1.DrawerContent onClick={function (e) { return e.stopPropagation(); }}>
                    <div className="text-[16px]">
                        <scroll_area_1.ScrollArea className="max-h-[80vh] pb-8">
...
exports.DrawerMobileWithoutContext = DrawerMobileWithoutContext;
