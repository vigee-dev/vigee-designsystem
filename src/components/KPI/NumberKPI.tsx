...
const NumberKPI = ({ stats }: NumberKPIProps) => {
  ...
  return (
    <div className="my-2">
      <dl className="grid grid-cols-1 divide-y divide-gray-0 overflow-hidden rounded-md shadow-sm md:grid-cols-3 md:divide-x md:divide-gray-100 md:divide-y-0  bg-white border border-slate-100">
        {stats.map((item) => (
