...
export function TableRowSkeleton({ size = 10 }: { size?: number }) {
  return (
    <table className="w-full my-4 bg-white rounded-md animate-pulse">
      <tbody>
        {size &&
          Array(size)
            .fill(0)
...
export function FormSkeleton({ size = 4 }: { size?: number }) {
  return (
    <div className="space-y-6 py-3 animate-pulse">
      {size &&
        Array(size)
          .fill(0)
          .map((_, i) => (
            <div key={i} className="flex flex-grid gap-24">
              <div className="space-y-2">
                <div className="h-6 w-16 rounded-md bg-gray-200"></div>
                <div className="h-6 w-96 rounded-md bg-gray-200"></div>
              </div>
              <div className="space-y-2">
                <div className="h-6 w-16 rounded-md bg-gray-200"></div>
                <div className="h-6 w-96 rounded-md bg-gray-200"></div>
...
export function DocumentSkeleton({ size = 6 }: { size?: number }) {
  return (
    <div className="w-max space-y-6 flex flex-col justify-center mx-auto">
      <div className="w-full space-y-4">
        <div className="h-6 w-96 rounded-md bg-gray-200"></div>
        <div className="h-6 w-64 rounded-md bg-gray-200"></div>
